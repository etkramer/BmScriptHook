...
/// <summary>
/// Class: RBMBehaviour_HarleyPred<br/>
/// (size = 520)
/// (flags = 8210)
/// </summary>
public partial class RBMBehaviour_HarleyPred : BmSDK.BmGame.RBMBehaviour, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RBMBehaviour_HarleyPred", false);
    ...
    /// <summary>
    /// Gets the class default object as RBMBehaviour_HarleyPred.
    /// </summary>
    public static RBMBehaviour_HarleyPred DefaultObject => (RBMBehaviour_HarleyPred)StaticClass().DefaultObject;

    internal RBMBehaviour_HarleyPred() { }

    /// <summary>
    /// Constructs a new RBMBehaviour_HarleyPred
    /// </summary>
    public RBMBehaviour_HarleyPred(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBMBehaviour_HarleyPred Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RBMBehaviour_HarleyPred(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_HarleyPred>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_HarleyPred>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmScript.RBMBehaviour_HarleyPred.GetObjClassVersion", true);
