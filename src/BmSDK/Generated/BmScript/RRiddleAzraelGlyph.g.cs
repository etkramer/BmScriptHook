...
/// <summary>
/// Class: RRiddleAzraelGlyph<br/>
/// (size = 476)
/// (flags = 8389138)
/// </summary>
public partial class RRiddleAzraelGlyph : BmSDK.BmGame.RRiddleSolutionBase, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RRiddleAzraelGlyph", false);
    ...
    /// <summary>
    /// Constructs a new RRiddleAzraelGlyph
    /// </summary>
    public RRiddleAzraelGlyph(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null, BmSDK.Engine.Level Level = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), default, Location, Rotation, Template, Owner, Instigator, Level)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RRiddleAzraelGlyph(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RRiddleAzraelGlyph>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RRiddleAzraelGlyph>, new()
    ...
    /// <summary>
    /// IntProperty: AzraelGlyphIndex
    /// </summary>
    public unsafe int AzraelGlyphIndex
    {
    ...
    /// <summary>
    /// BoolProperty: SpecialFinalGlyph
    /// </summary>
    public unsafe bool SpecialFinalGlyph
    {
    ...
    /// <summary>
    /// BoolProperty: GlyphEnabled
    /// </summary>
    public unsafe bool GlyphEnabled
    {
