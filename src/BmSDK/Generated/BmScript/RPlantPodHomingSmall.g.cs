...
/// <summary>
/// Class: RPlantPodHomingSmall<br/>
/// (size = 644)
/// (flags = 8388626)
/// </summary>
public partial class RPlantPodHomingSmall : BmSDK.BmGame.RPlantPodHomingSmallBase, BmSDK.BmGame.RBatarangableInterface, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RPlantPodHomingSmall", false);
    ...
    /// <summary>
    /// Constructs a new RPlantPodHomingSmall
    /// </summary>
    public RPlantPodHomingSmall(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null, BmSDK.Engine.Level Level = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), default, Location, Rotation, Template, Owner, Instigator, Level)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RPlantPodHomingSmall(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RPlantPodHomingSmall>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RPlantPodHomingSmall>, new()
    ...
    /// </summary>
    public unsafe BmSDK.BmGame.RPawn ChaseTarget
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RPawn>(Ptr + 496); }
    ...
    /// <summary>
    /// ComponentProperty: HaloFX
    /// </summary>
    public unsafe BmSDK.Engine.ParticleSystemComponent HaloFX
    {
    ...
    /// <summary>
    /// ObjectProperty: PodAnimSet
    /// </summary>
    public unsafe BmSDK.Engine.AnimSet PodAnimSet
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.AnimSet>(Ptr + 508); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 508); }
    }

    /// <summary>
    /// BoolProperty: bIsMachineGunOne
    /// </summary>
    public unsafe bool bIsMachineGunOne
    {
    ...
    /// <summary>
    /// BoolProperty: bSetFinalDest
    /// </summary>
    public unsafe bool bSetFinalDest
    {
    ...
    /// <summary>
    /// BoolProperty: bDirectHitOnBats
    /// </summary>
    public unsafe bool bDirectHitOnBats
    {
    ...
    /// <summary>
    /// BoolProperty: bAttachedToSpawner
    /// </summary>
    public unsafe bool bAttachedToSpawner
    {
    ...
    /// <summary>
    /// BoolProperty: bIgnoreDamageReduction
    /// </summary>
    public unsafe bool bIgnoreDamageReduction
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.CylinderComponent>(Ptr + 516); }
    ...
    /// <summary>
    /// FloatProperty: AccelerationValue
    /// </summary>
    ...
    /// </summary>
    public unsafe float ExplodeDist
    {
    ...
    /// <summary>
    /// FloatProperty: DamageCaused
    /// </summary>
    public unsafe float DamageCaused
    {
    ...
    /// </summary>
    public unsafe float HoldPositionTime
    {
    ...
    /// </summary>
    public unsafe float FinalDestinationAccel
    {
    ...
    /// <summary>
    /// FloatProperty: FinalDestinationSpeed
    /// </summary>
    public unsafe float FinalDestinationSpeed
    {
    ...
    /// <summary>
    /// IntProperty: RunningTime
    /// </summary>
    public unsafe int RunningTime
    {
    ...
    /// <summary>
    /// ArrayProperty: BlobMats
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.Engine.MaterialInstanceConstant> BlobMats
    {
    ...
    /// <summary>
    /// ObjectProperty: ClearMat
    /// </summary>
    public unsafe BmSDK.Engine.MaterialInstanceConstant ClearMat
    {
    ...
    /// <summary>
    /// IntProperty: CurrentSpeedArrayIndex
    /// </summary>
    public unsafe int CurrentSpeedArrayIndex
    {
    ...
    /// <summary>
    /// FloatProperty: RandTimeVal
    /// </summary>
    public unsafe float RandTimeVal
    {
    ...
    /// <summary>
    /// ComponentProperty: LaunchToFinalDestFX
    /// </summary>
    public unsafe BmSDK.Engine.AudioComponent LaunchToFinalDestFX
    {
    ...
    /// </summary>
    public unsafe BmSDK.Engine.SkeletalMeshActor Spawner
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.Engine.SkeletalMeshActor>(Ptr + 640); }
