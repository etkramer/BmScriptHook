...
public partial class RRobinStaffShield : BmSDK.BmScript.RRobinStaff, BmSDK.IGameObject
{
    ...
    /// <summary>
    /// Gets the class default object as RRobinStaffShield.
    /// </summary>
    public static RRobinStaffShield DefaultObject => (RRobinStaffShield)StaticClass().DefaultObject;
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmScript.RRobinStaffShield.CanThrowGadget", true);
        byte* paramsPtr = stackalloc byte[8];
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
        return BmSDK.Framework.MarshalUtil.ToManaged<bool>(paramsPtr + 0);
    }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<BmSDK.Engine.Actor>>(Ptr + 992); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.TArray<int>>(Ptr + 1004); }
