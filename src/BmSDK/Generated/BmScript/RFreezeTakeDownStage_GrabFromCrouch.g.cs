...
/// <summary>
/// Class: RFreezeTakeDownStage_GrabFromCrouch<br/>
/// (size = 1096)
/// (flags = 8388626)
/// </summary>
public partial class RFreezeTakeDownStage_GrabFromCrouch : BmSDK.BmScript.RFreezeTakeDownStage, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RFreezeTakeDownStage_GrabFromCrouch", false);
    ...
    /// <summary>
    /// Constructs a new RFreezeTakeDownStage_GrabFromCrouch
    /// </summary>
    public RFreezeTakeDownStage_GrabFromCrouch(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null, BmSDK.Engine.Level Level = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), default, Location, Rotation, Template, Owner, Instigator, Level)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RFreezeTakeDownStage_GrabFromCrouch(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RFreezeTakeDownStage_GrabFromCrouch>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RFreezeTakeDownStage_GrabFromCrouch>, new()
