...
/// <summary>
/// Class: RBMBehaviour_TwoFace<br/>
/// (size = 520)
/// (flags = 8210)
/// </summary>
public partial class RBMBehaviour_TwoFace : BmSDK.BmGame.RBMBehaviour, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RBMBehaviour_TwoFace", false);
    ...
    /// <summary>
    /// Gets the class default object as RBMBehaviour_TwoFace.
    /// </summary>
    public static RBMBehaviour_TwoFace DefaultObject => (RBMBehaviour_TwoFace)StaticClass().DefaultObject;

    internal RBMBehaviour_TwoFace() { }

    /// <summary>
    /// Constructs a new RBMBehaviour_TwoFace
    /// </summary>
    public RBMBehaviour_TwoFace(BmSDK.GameObject Outer, string Name = null, BmSDK.GameObject.EObjectFlags SetFlags = 0, RBMBehaviour_TwoFace Template = null) : base(ConstructObjectInternal(StaticClass(), Outer, Name, SetFlags, Template)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RBMBehaviour_TwoFace(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_TwoFace>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RBMBehaviour_TwoFace>, new()
    ...
    {
        var funcManaged = BmSDK.GameObject.StaticFindObjectChecked<BmSDK.Function>(BmSDK.Function.StaticClass(), null, "BmScript.RBMBehaviour_TwoFace.GetObjClassVersion", true);
    ...
    /// <summary>
    /// ObjectProperty: StartingPoint
    /// </summary>
    public unsafe BmSDK.BmGame.RSniperPoint StartingPoint
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RSniperPoint>(Ptr + 396); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 396); }
    }

    /// <summary>
    /// ObjectProperty: AlertedPoint
    /// </summary>
    public unsafe BmSDK.BmGame.RSniperPoint AlertedPoint
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RSniperPoint>(Ptr + 400); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 400); }
    }

    /// <summary>
    /// ObjectProperty: AlertedPoint2
    /// </summary>
    public unsafe BmSDK.BmGame.RSniperPoint AlertedPoint2
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RSniperPoint>(Ptr + 404); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 404); }
    }

    /// <summary>
    /// ObjectProperty: AlertedPoint3
    /// </summary>
    public unsafe BmSDK.BmGame.RSniperPoint AlertedPoint3
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RSniperPoint>(Ptr + 408); }
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RSniperPoint>(Ptr + 412); }
    ...
    /// <summary>
    /// IntProperty: CurrAlertedPoint
    /// </summary>
    public unsafe int CurrAlertedPoint
    {
    ...
    /// <summary>
    /// IntProperty: PrevAlertedPoint
    /// </summary>
    public unsafe int PrevAlertedPoint
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RNavigationHandle>(Ptr + 428); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 428); }
    }

    /// <summary>
    /// IntProperty: NumAimAts
    /// </summary>
    public unsafe int NumAimAts
    {
    ...
    /// <summary>
    /// BoolProperty: bFiredRocket
    /// </summary>
    public unsafe bool bFiredRocket
    {
    ...
    /// <summary>
    /// BoolProperty: bTaunted
    /// </summary>
    public unsafe bool bTaunted
    {
    ...
    /// <summary>
    /// BoolProperty: bTryTaunt
    /// </summary>
    public unsafe bool bTryTaunt
    {
    ...
    /// <summary>
    /// BoolProperty: bScaredThug
    /// </summary>
    public unsafe bool bScaredThug
    {
    ...
    /// <summary>
    /// BoolProperty: bAlerted
    /// </summary>
    public unsafe bool bAlerted
    {
    ...
    /// <summary>
    /// BoolProperty: bDialogueEnabled
    /// </summary>
    public unsafe bool bDialogueEnabled
    {
    ...
    /// <summary>
    /// StructProperty: AimID
    /// </summary>
    public unsafe ref BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId AimID
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId>(Ptr + 444);

    /// <summary>
    /// StructProperty: RelaxID
    /// </summary>
    public unsafe ref BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId RelaxID
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId>(Ptr + 448);

    /// <summary>
    /// StructProperty: FireID
    /// </summary>
    public unsafe ref BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId FireID
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId>(Ptr + 452);

    /// <summary>
    /// StructProperty: TauntID
    /// </summary>
    public unsafe ref BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId TauntID
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.BmGame.RAnimUtil_PosePlayer.FTransitionId>(Ptr + 456);

    /// <summary>
    /// StructProperty: SniperPointLocation
    /// </summary>
    public unsafe ref System.Numerics.Vector3 SniperPointLocation
        => ref BmSDK.Framework.MarshalUtil.AsRef<System.Numerics.Vector3>(Ptr + 460);

    /// <summary>
    /// StructProperty: SniperPointRotation
    /// </summary>
    public unsafe ref BmSDK.Rotator SniperPointRotation
        => ref BmSDK.Framework.MarshalUtil.AsRef<BmSDK.Rotator>(Ptr + 472);

    /// <summary>
    /// FloatProperty: DialogueTimer
    /// </summary>
    public unsafe float DialogueTimer
    {
    ...
    /// <summary>
    /// FloatProperty: IdleDialogueTimer
    /// </summary>
    public unsafe float IdleDialogueTimer
    {
    ...
    /// <summary>
    /// FloatProperty: CantSeeTimer
    /// </summary>
    public unsafe float CantSeeTimer
    {
    ...
    {
        get { return BmSDK.Framework.MarshalUtil.ToManaged<BmSDK.BmGame.RAttackPointSearch>(Ptr + 500); }
        set { BmSDK.Framework.MarshalUtil.ToUnmanaged(value, Ptr + 500); }
    }

    /// <summary>
    /// StructProperty: ShootPlayerLocation
    /// </summary>
    public unsafe ref System.Numerics.Vector3 ShootPlayerLocation
        => ref BmSDK.Framework.MarshalUtil.AsRef<System.Numerics.Vector3>(Ptr + 504);

    /// <summary>
    /// FloatProperty: TimeSinceInterrupt
    /// </summary>
    public unsafe float TimeSinceInterrupt
    {
