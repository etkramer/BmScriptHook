...
/// <summary>
/// Class: RFreezeTakeDownStage_LedgeGrab<br/>
/// (size = 1124)
/// (flags = 8388626)
/// </summary>
public partial class RFreezeTakeDownStage_LedgeGrab : BmSDK.BmScript.RFreezeTakeDownStage, BmSDK.IGameObject
{
    ...
    public static BmSDK.Class StaticClass()
    {
        ...
        {
            s_staticClass = StaticFindObjectChecked<Class>(null, null, "BmScript.RFreezeTakeDownStage_LedgeGrab", false);
    ...
    /// <summary>
    /// Constructs a new RFreezeTakeDownStage_LedgeGrab
    /// </summary>
    public RFreezeTakeDownStage_LedgeGrab(System.Numerics.Vector3 Location = default, BmSDK.Rotator Rotation = default, BmSDK.Engine.Actor Template = null, BmSDK.GameObject Owner = null, BmSDK.GameObject Instigator = null, BmSDK.Engine.Level Level = null) : base(BmSDK.Framework.Game.SpawnActorInternal(StaticClass(), default, Location, Rotation, Template, Owner, Instigator, Level)) { }

    /// <summary>
    /// Constructs a new wrapper instance from the given object pointer.
    /// </summary>
    protected RFreezeTakeDownStage_LedgeGrab(nint ptr) : base(ptr) { }

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Framework.IScriptComponent)"/>
    public void AttachScriptComponent<TComponent>(TComponent component)
        where TComponent : class, Framework.IScriptComponent<RFreezeTakeDownStage_LedgeGrab>
        => ((GameObject)this).AttachScriptComponent((Framework.IScriptComponent)component);

    /// <inheritdoc cref="GameObject.AttachScriptComponent(Type)"/>
    public TComponent AttachScriptComponent<TComponent>()
        where TComponent : class, Framework.IScriptComponent<RFreezeTakeDownStage_LedgeGrab>, new()
    ...
    /// <summary>
    /// BoolProperty: bIsOnLeft
    /// </summary>
    public unsafe bool bIsOnLeft
    {
    ...
    /// <summary>
    /// ArrayProperty: PlayerAnimationsByDirection
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.FName> PlayerAnimationsByDirection
    {
    ...
    /// <summary>
    /// ArrayProperty: BackupCameras
    /// </summary>
    public unsafe BmSDK.TArray<BmSDK.FName> BackupCameras
    {
