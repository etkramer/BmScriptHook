...
public partial class RBMCombatThrownObject : BmSDK.Engine.KAsset, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe virtual System.Numerics.Vector3 IsInRangeOfMagneticSurface(ref System.Numerics.Vector3 SourceLocation, bool bInformMagneticSurface, ref float Strength, ref float ChargeTimer, ref float ChargeDuration)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(ChargeTimer, paramsPtr + 20);
        BmSDK.Framework.MarshalUtil.ToUnmanaged(ChargeDuration, paramsPtr + 24);
        var oldFlags = funcManaged.FunctionFlags;
        var oldNative = funcManaged.iNative;
        funcManaged.FunctionFlags &= ~BmSDK.Function.EFunctionFlags.FUNC_Native;
        funcManaged.FunctionFlags |= BmSDK.Function.EFunctionFlags.FUNC_Defined;
