...
public partial class RMagneticBlast : BmSDK.BmGame.RInventoryGadget, BmSDK.IGameObject
{
    ...
    /// </summary>
    public unsafe virtual System.Numerics.Vector3 IsInRangeOfMagneticSurface(BmSDK.BmGame.RBMCombatThrownObject TestActor, ref System.Numerics.Vector3 SourceLocation, bool bInformReceiver, ref float Strength, ref float ChargeTimer, ref float ChargeDuration)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(Strength, paramsPtr + 20);
        BmSDK.Framework.MarshalUtil.ToUnmanaged(ChargeTimer, paramsPtr + 24);
        BmSDK.Framework.MarshalUtil.ToUnmanaged(ChargeDuration, paramsPtr + 28);
        BmSDK.Framework.GameFunctions.ProcessEvent(Ptr, funcManaged.Ptr, (nint)paramsPtr, 0);
    ...
    /// </summary>
    public unsafe virtual BmSDK.Engine.Actor TraceTargets(ref System.Numerics.Vector3 HitLocation, ref BmSDK.Engine.Actor.FTraceHitInfo HitInfo, System.Numerics.Vector3 TraceEnd, System.Numerics.Vector3 TraceStart)
    {
        ...
        BmSDK.Framework.MarshalUtil.ToUnmanaged(HitInfo, paramsPtr + 12);
